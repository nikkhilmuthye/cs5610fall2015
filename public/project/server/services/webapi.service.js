module.exports = function(app, model) {
    app.post("/api/project/webapi", Create);
    app.get("/api/project/webapi", FindUsers);
    app.get("/api/project/webapi/:id", FindById);
    app.put("/api/project/webapi/:id", Update);
    app.delete("/api/project/webapi/:id", Delete);
    app.get("/api/project/webapi/getStandings", getStandings);
